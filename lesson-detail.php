                                    ...
                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                                                ...
                                                <div class="accordion-body">
                                                    <div class="tab-nav">
                                                        <button class="nav-link tab-btn line active" id="v-pills-home-tab"
                                                        ...
                                                        <button class="nav-link tab-btn" id="v-pills-profile-tab"
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapsetwo" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <div class="tab-nav">
                                                        <button class="nav-link tab-btn line" id="v-pills-three-tab"
                                                            ...
                                                            <p>Lesson 1a (Watch) – Introduction
                                                                <span><i class="fa-solid fa-video"></i> Video – 15
                                                                    min</span>
                                                            </p>
                                                        </button>
                                                        <button class="nav-link tab-btn line" id="v-pills-four-tab"
                                                            ...
                                                            <p>Lesson 1b (Listen) – Introduction
                                                                <span><i class="fa-solid fa-headphones"></i>
                                                                    Audio</span>
                                                            </p>
                                                        </button>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="main-box">
                                        ...
                                        <div class="content-with-box">
                                            ...
                                            <div class="para">
                                                <div class="box">
                                                    <h4>All in one sitting</h4>
                                                    <p>(Approx. 2.5 hours) Homework time varies</p>
                                                </div>
                                                <div class="box">
                                                    <h4>Slowly over 9 weeks</h4>
                                                    <p>(Approx. 30 minutes/week) Homework time varies</p>
                                                </div>
                                                <div class="box">
                                                    <h4>Hybrid Course</h4>
                                                    <p>Mix of audio, reading and video Pick and choose where to start Come back and review anytime Homework time varies</p>
                                                </div>
                                            </div>
                                            <h3>Formats:</h3>
                                            <p>We have offered the course content in 3 formats so you can choose the one
                                                you prefer for each week.</p>
                                            <ul>
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                    ...
                                    <div class="main-box">
                                        ...
                                        <div class="content-with-box">
                                            <h3></h3>
                                            <p>You can take the course all in one sitting, over a few weeks or a blend
                                                of
                                    ...
                                    <div class="main-box">
                                        ...
                                        <div class="content-with-box">
                                            <div class="card">
                                                ...
                                                <p>You can take the course all in one sitting, over a few weeks or a
                                                    blend of both, it's up to you.</p>
                                            </div>
                                        </div>
                                        <div class="btn-complete">
                                            <button class="btn btn-mark">Mark InComplete</button>
                                    ...
                                    <div class="main-box">
                                        ...
                                        <div class="content-with-box">
                                            <div class="card">
                                                ...
                                                <p>
                                                    You can take the course all in one sitting, over a few weeks or a
                                                    blend of both, it's up to you.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="btn-complete">
                                ...
                                <div class="tab-pane fade" id="v-pills-five" role="tabpanel"
                                    ...
                                    <div class="main-box">
                                        ...
                                        <div class="content-with-box">
                                            <embed src="assets/images/rrr.pdf" type="application/pdf" width="100%"
                                                height="600px">
                                        </div>
                                        <div class="btn-complete">
                                            <button class="btn btn-mark">Mark InComplete</button>
